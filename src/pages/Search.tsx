            ...
            <Paper sx={{ borderRadius: '30px', minWidth: 100, maxHeight: 900 }}>
               {windowSize <= 1500 ? (
                  <Stack
                     ...
                     alignContent="center"
                     spacing={3}
                     sx={{ paddingTop: 5, paddingLeft: 5, paddingRight: 5, paddingBottom: 5 }}>
                     <FormControl sx={{ minWidth: 150 }}>
                        <InputLabel id="cido">시/도</InputLabel>
                        <Select value={select} onChange={e => sidohandleChange(e)} autoWidth label="시/도">
                           {sido.map(v => (
                     ...
                     <FormControl sx={{ minWidth: 100 }}>
                        ...
                        <Select value={gunselect} onChange={gunhandleChange} autoWidth label="군/구">
                           {gungu.map(value => (
                     ...
                     <FormControl sx={{ minWidth: 150 }}>
                        ...
                        <Select value={placeselect} onChange={placehandleChange} autoWidth label="보호소">
                           {place.map(value => (
                              <MenuItem value={value}>{value}</MenuItem>
                           ))}
                        </Select>
                     ...
                     <FormControl sx={{ minWidth: 110 }}>
                        ...
                        <Select value={animalselect} onChange={animalhandleChange} autoWidth label="개/고양이">
                           {animal.map(v => (
                     ...
                     <FormControl sx={{ minWidth: 150 }}>
                        ...
                        <Select value={indexselect} onChange={indexhandleChange} autoWidth label="품종">
                           {index.map(v => (
                              <MenuItem value={v}>{v}</MenuItem>
                           ))}
                        </Select>
                     ...
                     <FormControl sx={{ minWidth: 110 }}>
                        ...
                        <Select value={stateselect} onChange={statehandleChange} autoWidth label="현재상태">
                           {state.map(v => (
                              <MenuItem value={v.id}>{v.name}</MenuItem>
                           ))}
                        </Select>
                     ...
                     <FormControl sx={{ minWidth: 130 }}>
                        ...
                        <Select value={yesselect} onChange={yeshandleChange} autoWidth label="중성화 여부">
                           {yes.map(v => (
                              <MenuItem value={v.id}>{v.name}</MenuItem>
                           ))}
                        </Select>
